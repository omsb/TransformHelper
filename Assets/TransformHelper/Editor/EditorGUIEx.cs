...
namespace OMSB
{
    ...
    public class EditorGUIEx : EditorWindow
    {
        ...
        private static GUIStyle	g_BoxStyle;
        ...
        public static bool DrawGroup(string key, string caption, Color color)
        {
        ...
        public static bool DrawGroup(string caption, Color color) 
        {
            return DrawGroup(caption, caption, color);
        }
        public static bool DrawGroup(string caption) {
            return DrawGroup(caption, caption, GROUP_COLOR);
        }
